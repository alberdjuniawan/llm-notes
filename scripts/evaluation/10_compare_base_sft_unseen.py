...
def parse_args() -> ArgumentParser:
    parser = ArgumentParser(
        description="Compare base and SFT model generations on unseen prompts."
    )
    parser.add_argument(
        "--base-model",
        type=str,
...
def main() -> None:
    ...
    prompts = [
        "User: Explain evaporation for a fifth-grade student.\nAssistant:",
        "User: Why does the Moon seem to change shape during the month?\nAssistant:",
        "User: Explain the difference between mass and weight in simple terms.\nAssistant:",
        "User: How do roots help a plant get water?\nAssistant:",
        "User: What does multiplication mean in simple terms?\nAssistant:",
    ]
